			...
			<div class="s5_tab_show_slides_container_wrap_outer">
				...
				<?php if ($arrow_location == "overlay") { ?>	
					...
					<div class="s5_tab_show_next_prev_wrapper  s5_tab_show_next_prev_bottom">
						...
						<div <?php echo $mouse_effect_arrows; ?>="s5_tab_show_trigger_prev(this.id)" class="s5_tab_show_next_prev s5_tab_show_prev" id="s5_tab_show_prev_id<?php echo $s5_tab_show_random_id; ?>"><span class="s5_tab_show_prev_text">Prev</span></div>

						<div <?php echo $mouse_effect_arrows; ?>="s5_tab_show_trigger_next(this.id)" class="s5_tab_show_next_prev s5_tab_show_next" id="s5_tab_show_next_id<?php echo $s5_tab_show_random_id; ?>"><span class="s5_tab_show_next_text">Next</span></div>
