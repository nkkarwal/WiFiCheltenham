 ...
 * @since       1.6
 */
abstract class mods5IACFHelper
{
	/**
	...
	public static function getList(&$params)
	{
		...
		//$model->setState('list.limit', (int) $params->get('count', 100));
		...
		foreach ($items as &$item)
		{
			...
			if ($access || in_array($item->access, $authorised))
			{
				...
				$item->linkText = JText::_('MOD_IACF_READMORE');
			}
			else
			{
				...
				$item->linkText = JText::_('MOD_IACF_REGISTER');
			}
			...
			// JH 1/10/2017 - added below per user fix on the forum
