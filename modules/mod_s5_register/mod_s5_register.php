...
/** @title		Shape 5 Register Module
  ...
  * @license	GNU/GPL, see LICENSE.php* Joomla! is free software. This version may have been modified pursuant
...
if (!$user->id) {
	...
	$form = new JForm('registration');
	$form->loadFile(JPATH_ROOT.DS.'components'.DS.'com_users'.DS.'models'.DS.'forms'.DS.'registration.xml');
	$captcha = '';
